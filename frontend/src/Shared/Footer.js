...
const Footer = () => {
    return (
        ...
        <footer style={{ backgroundImage: `url(${bg})` }} className="bg-no-repeat bg-cover min-h-[400px] p-10  bg-neutral">
            ...
            <p className='text-center font-bold my-2'>&#169;{new Date().getFullYear()} Triviamania All rights reserved.</p>
        </footer>
